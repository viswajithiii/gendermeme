...
def analyze_error(corenlp_fn, manual_path, annotator):
    ...
    print 'Total mentions (true)', float(sum([all_errors[_id][1]['total_m_count'] for _id in all_errors]))
    print 'Total mention_diff', float(sum([all_errors[_id][1]['mean_diff_mention_count'] for _id in all_errors]))

    print 'Total quotes (true)', float(sum([all_errors[_id][1]['total_m_quotes'] for _id in all_errors]))
    print 'Total quotes_diff', float(sum([all_errors[_id][1]['mean_diff_quote_count']for _id in all_errors]))
